            ...
            <Grid type="large">
                <Card>
                    ...
                    <p className="card-news__desc" onClick={handleClick}>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti qui est incidunt reiciendis tenetur blanditiis! At iste
                        tempora necessitatibus nihil harum, dignissimos quos mollitia sed, nisi magnam non, molestias magni!
                    </p>
